    ...
    <div class="container">
      ...
      <table class="table table-hover mt-4 text-center">
        ...
        <tbody class="table-group-divider text-center">
          ...
          $query=$db->query("SELECT mahasiswa.nim, mahasiswa.nama, file_khs, smt from mahasiswa,khstemp,dosen where mahasiswa.nim=khstemp.nim and mahasiswa.kode_wali = dosen.kode_wali");
          while($row=$query->fetch_object()){
            echo '<tr>';
            echo '<td>'.$row->nama.'</td>';
            echo '<td>'.$row->nim.'</td>';
            echo '<td>'.$row->smt.'</td>';
            echo '<td>'.$row->file_khs.'</td>';
