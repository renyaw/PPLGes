    ...
    <div class="container">
      ...
      <div class="d-grid gap-2 mt-5 d-md-block">
        ...
        <a href="srs132020.php">
          <button class="btn btn-secondary" type="button">2020</button>
        </a>
          ...
          <div class="col-md-4 mx-auto mt-5">
            <div class="card" style="background-color: #92ff80; height: 200px">
              <div class="card-body text-center">
                ...
                <h3>
                  <?php
                    $query = $db->query("SELECT COUNT(khs.nim) FROM khs, mahasiswa WHERE khs.status = '1' AND khs.nim = mahasiswa.nim AND mahasiswa.angkatan = '2020'");
          ...
          <div class="col-md-4 mx-auto mt-5">
            <div class="card" style="background-color: #ed8282; height: 200px">
              <div class="card-body text-center my-auto">
                ...
                <h3>
                  <?php
                    $query = $db->query("SELECT COUNT(khs.nim) FROM khs, mahasiswa WHERE khs.status = '0' AND khs.nim = mahasiswa.nim AND mahasiswa.angkatan = '2020'");
                    $data = mysqli_fetch_assoc($query);
                    echo $data['COUNT(khs.nim)'];
                  ?>
                <br /><br />Belum PKL</h3>
